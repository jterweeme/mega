...
app_web1.elf: app_web1.o arp.o dns.o dhcp.o uip_server.o uip_client.o uip_ethernet.o \
    uip.o uip_udp.o network.o misc.o zd2card.o zd.o zdfile.o zdvolume.o fyle.o uip_timer.o
app_sdls1.elf: app_sdls1.o zd2card.o zd.o zdfile.o zdvolume.o fyle.o misc.o
